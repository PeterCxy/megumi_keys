 ...
 */
#define USB_CFG_VENDOR_NAME    'A', 'n', 'g', 'r', 'y', '.', 'I', 'm'
 ...
 */
#define USB_CFG_HID_REPORT_ID_NUM 6
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    49 + 37 * (USB_CFG_HID_REPORT_ID_NUM - 1)
